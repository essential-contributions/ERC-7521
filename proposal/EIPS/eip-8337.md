...
description: A generalized intent specification for smart contract wallets to interface with which does not require wallet upgrades with each new standard, instead allowing sign time opt-in by users.
