...
/**
 * Based on the BLS contracts from the Hubble Project.
 * Find the original source here: https://github.com/thehubbleproject/hubble-contracts/blob/master/contracts/libs/BLS.sol
 */
...
library BLS {
        ...
        view
    {
        ...
        require(callSuccess, "BLS: failed to verify single signature");
        require(out[0] != 0, "BLS: invalid signature");
    }
        ...
        view
    {
        ...
        require(callSuccess, "BLS: failed to verify aggregated signature");
        require(out[0] != 0, "BLS: invalid aggregated signature");
    }
