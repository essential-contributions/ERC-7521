...
contract SimpleAccount is BaseAccount, UUPSUpgradeable, Initializable, IProxyAccount {
    ...
    function _onlyOwner() internal view {
        ...
        require(msg.sender == owner || msg.sender == address(this), "not account owner");
    }

    function _requireFromEntryPointOrOwner() internal view {
        require(msg.sender == address(_entryPoint) || msg.sender == owner, "not account owner or entrypoint");
    }
