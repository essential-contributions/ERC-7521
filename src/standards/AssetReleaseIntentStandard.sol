...
contract AssetReleaseIntentStandard is IIntentStandard, BaseStandard, AssetReleaseIntentDelegate {
     ...
     */
    constructor(IEntryPoint entryPointContract) BaseStandard(entryPointContract) AssetReleaseIntentDelegate() {}
