 ...
 */
abstract contract EthReleaseExponentialCore is EthReleaseDelegate {
    /**
     * Validate intent segment structure (typically just formatting).
     */
    function _validateEthReleaseExponential(bytes calldata segmentData) internal pure {
     ...
     */
    function _executeEthReleaseExponential(
        uint256 timestamp,
 ...
 */
contract EthReleaseExponential is EthReleaseExponentialCore, IIntentStandard {
 ...
 */
function encodeEthReleaseExponentialData(
    bytes32 standardId,
    uint40 startTime,
    uint32 deltaTime,
    int256 startAmount,
